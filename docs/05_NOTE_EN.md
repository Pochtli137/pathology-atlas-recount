...
In ten of twenty-one cohorts the observed number of prognostic genes is within what permutation produces (one-sided permutation p > 0.05 for the count; with 200 permutations the resolution is 0.005): COAD, GBM, LUSC, OV, PRAD, SKCM, STAD, TGCT, THCA, UCEC. READ (10 of 200 permutations at or above the observed count) and BLCA (11 of 200) are borderline. The other nine carry more signal than chance (at most 5 of 200), BRCA the weakest.
